...
DEFINED = OrderedDict([
            ('VLAB_INSIGHTIQ_LOG_LEVEL', environ.get('VLAB_INSIGHTIQ_LOG_LEVEL', 'INFO')),
            ...
            ('VLAB_MESSAGE_BROKER', environ.get('VLAB_MESSAGE_BROKER', 'insightiq-broker')),
            ('VLAB_URL', environ.get('VLAB_URL', 'https://localhost')),
            ('VLAB_INSIGHTIQ_IMAGES_DIR', environ.get('VLAB_INSIGHTIQ_IMAGES_DIR', '/images')),
          ])
